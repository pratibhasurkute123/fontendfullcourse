      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <NavLink to={'/product'} className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Product</NavLink>
            <NavLink to={'/services'} className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Services</NavLink>
            <NavLink to={'/gallary'} className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Gallary</NavLink>
